    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; margin:0; padding:0; }
        ...
        .portrait-wrap img { width: 100%; height: 100%; object-fit: contain; display: block; }
        ...
        .description { grid-column: 1 / 4; grid-row: 3 / 4; justify-self: center; align-self: end; font-family: var(--mono); font-size: clamp(12px, 1vw, 14px); line-height: 1.5; text-align: center; width: min(900px, 92%); opacity: 0; animation: fade-up-slight 0.9s ease-out 1.15s forwards; z-index: 4; margin-bottom: 2px; }
