    ...
    <>
      <style>{`
        ...
        * { box-sizing:border-box; }
        ...
        .page-container { display:flex; flex-direction:column; justify-content:space-between; height:100vh; width:100%; position:relative; transition: transform 1s ease-in-out, opacity 1s ease-in-out; transform: ${shutter ? "scale(0.7) translateY(-30px)" : "scale(1) translateY(0)"}; opacity: ${shutter ? 0 : 1}; z-index:1; overflow:hidden; }
        ...
        .header-group { display:flex; flex-wrap: nowrap; justify-content:center; align-items:baseline; font-size: clamp(2rem, 12vw, 6rem); gap:0.2ch; white-space: nowrap; margin: 2vh auto 0 auto; max-width: 95vw; overflow: hidden; position: relative; }
        ...
        footer { text-align:center; width:100%; padding:2vh 0 4vh 0; position:relative; }
        ...
        @media (max-width:768px){
          .header-group{font-size:clamp(1.5rem,8vw,4.5rem);}
          .main-nav{flex-direction:column; align-items:center; gap:1rem;}
          .middle-text{font-size:clamp(0.7rem,2vw,1rem);}
        }
        @media (max-width:480px){
          .header-group{font-size:clamp(1.2rem,6vw,4rem); margin-top:3vh;}
          .main-nav{gap:0.8rem;}
          .middle-text{font-size:clamp(0.6rem,3vw,0.9rem);}
          footer{padding:3vh 1rem 5vh 1rem;}
          .footer-title{font-size:clamp(1.5rem,7vw,4rem);}
          .arrow{width:1.5rem; height:1.5rem; border-left:2px solid rgba(255,255,255,0.7); border-bottom:2px solid rgba(255,255,255,0.7);}
        }
      `}</style>
