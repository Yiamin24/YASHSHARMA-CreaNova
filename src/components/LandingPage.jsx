    ...
    <>
      <style>{`
        ...
        * { box-sizing:border-box; }
        ...
        .page-container { display:flex; flex-direction:column; justify-content:space-between; height:100vh; width:100%; position:relative; transition: transform 1s ease-in-out, opacity 1s ease-in-out; transform: ${shutter ? "scale(0.7) translateY(-30px)" : "scale(1) translateY(0)"}; opacity: ${shutter ? 0 : 1}; z-index:1; overflow-x:hidden; }
        .content-wrapper { display:flex; flex-direction:column; justify-content:space-between; align-items:center; flex:1; width:100%; padding:2vw 5vw; overflow:hidden; position:relative; }
        ...
        .main-nav { display:flex; justify-content:space-between; align-items:center; width:100%; max-width:1200px; font-size:clamp(0.8rem,1.2vw,1rem); text-transform:uppercase; letter-spacing:0.1em; margin:auto 0; position:relative; gap: 1rem; flex-wrap:wrap; text-align:center; }
        .middle-text { text-align:center; white-space:normal; opacity:0; animation: fadeSlide 2s forwards; animation-delay:0.5s; margin:1rem 0; color:white; font-size:clamp(0.8rem,1.5vw,1.2rem);}
        @keyframes fadeSlide { 0%{opacity:0; transform:translateY(20px);} 100%{opacity:1; transform:translateY(0);} }
        footer { text-align:center; width:100%; padding:2vh 0; position:relative; overflow:hidden; }
        .footer-title { font-family:'Bodoni Moda', serif; font-style:italic; font-size:clamp(2rem, 5vw, 5rem); display:flex; justify-content:center; align-items:center; position:relative; gap:1ch; z-index:1; }
        ...
        @media (max-width:768px){ .swipe-up{display:block;} .header-group{font-size:clamp(1.5rem,8vw,4.5rem);} .main-nav{flex-direction:column; align-items:center; gap:1rem;} .middle-text{font-size:clamp(0.7rem,2vw,1rem);} }
        @media (min-width:769px){ .swipe-up{display:none;} }
      ...
      <div className="page-container">
        <div className="content-wrapper">
          ...
          {/* Swipe Up Indicator */}
          <div className="swipe-up">SWIPE UP</div>
